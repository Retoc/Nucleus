...
public abstract class NucleusTextTemplateImpl implements NucleusTextTemplate {
    ...
    private static final TextParsingUtils.StyleTuple EMPTY = new TextParsingUtils.StyleTuple(TextColors.NONE, TextStyles.NONE);
    ...
    private Text getTextForUrl(String url, String msg, String whiteSpace, ITextStyleService.TextFormat st, @Nullable String optionString) {
        ...
        try {
            ...
            plugin.getLogger().warn(messageProviderService.getMessageString("chat.url.malformed", url));
            e.printStackTrace();
