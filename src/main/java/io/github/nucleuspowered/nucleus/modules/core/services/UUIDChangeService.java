...
public class UUIDChangeService implements Reloadable, NucleusWorldUUIDChangeService, ServiceBase {
    ...
    public void onReload(INucleusServiceCollection serviceCollection) {
        ...
        this.mapping = serviceCollection.getServiceUnchecked(CoreConfigAdapter.class).getNodeOrDefault().getUuidMigration()
                .entrySet().stream()
                .map(x -> {
                    try {
