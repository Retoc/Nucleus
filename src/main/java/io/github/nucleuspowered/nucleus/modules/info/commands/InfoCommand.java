...
public class InfoCommand implements ICommandExecutor<CommandSource>, Reloadable {
    ...
    public CommandElement[] parameters(INucleusServiceCollection serviceCollection) {
        return new CommandElement[] {
            GenericArguments.flags()
                    ...
                    .buildWith(
                        GenericArguments.optional(new InfoArgument(Text.of(this.key), this.infoService)))
        };
    }
